  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: isShowUsers?FutureBuilder(
        future: FirebaseFirestore.instance.collection('users').where('username',isGreaterThanOrEqualTo: searchController.text,
        )
            .get(),
      ...
      FutureBuilder(
        future: FirebaseFirestore.instance.collection('posts').get(),
         ...
         //     ),
         //     staggerrdTileBuilder: (index) => StaggeredGridTile.count(
         //         crossAxisCellCount: (index%7==0)?2:1,
         //         mainAxisCellCount: (index%7)==0?2:1, child: index
         //     ),
         //     mainAxisSpacing: 8,
         //   );
